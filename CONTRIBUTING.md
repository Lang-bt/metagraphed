...
> **Plagiarism is not tolerated.** Copying another contributor's PR, surface, or work and submitting it as your own — including duplicated or lightly reworded copies filed under a different account — is a hard violation. Don't copy others to farm Gittensor rewards: anyone attempting to cheat or copy for gain is **permanently blocked from contributing across all of our repositories**. Enforcement is proportional — reward-farming (manufacturing low-value/slop issues to harvest credit, or bulk surface PRs filed for points) earns a warning and no linked-issue bonus, and repeat or coordinated farming is closed on sight and blocked. See [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) for the full ladder.
